...
describe('Central de Atendimento ao Cliente TAT', function () {
    ...
    it('Exibe mensagem de erro ao submeter o furmulário com um email com formatação inválida', function () {
        cy.clock()
    ...
    it('Preenche e limpa os campos nome, sobrenome, email e telefone', function () {
        ...
        cy.get('#lastName')
            ...
            .should('have.value', '')
        cy.get('#email')
            .type('afmcmorais@teste.com')
            .should('have.value', 'afmcmorais@teste.com')
            .clear()
            .should('have.value', '')
        cy.get('#phone')
            .type('61900000001')
            .should('have.value', '61900000001')
            .clear()
            .should('have.value', '')
    })
    ...
    it('Verifque que a política de privacidade abre em outra aba sem a necessidade de um clique', function () {
